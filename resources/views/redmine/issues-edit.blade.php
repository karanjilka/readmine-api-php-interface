...
<div id="app">
    ...
    <table class="table">
        ...
        <tr v-for="issue in issues">
            <td>                
                {!! Laform::field('id','text',['template'=>'none',
                    'label'=>false,                  
                    'attr'=>['v-model'=>'issue.id'],
                    'wrapper_attr'=>['v-bind:class'=>'{ \'has-error\': errors[\'issues.\'+$index+\'.id\']}'],
                    'field_suffix'=>'<div class="text-danger" v-for="error in errors[\'issues.\'+$index+\'.id\']">@{{error}}</div>'
                ]) !!}
            </td>
            <td>               
            ...
            <td width="30%">                
                ...
                'label'=>false,
                'attr'=>['rows'=>1,'v-model'=>'issue.subject'],
